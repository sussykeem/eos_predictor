...
from eos_dataloader import EOS_Dataloader as Eos_Predictloader
...
models_path = os.path.join(os.path.dirname(__file__), 'baseline_models')
...
class Baseline_Model():
    ...
    def __init__(self, type, data):
        ...
        self.models_path = [
            'baseline_models/base_model_weights/random_forest.pth',
        ...
        if type == 'predictor':
            self.model = self.models[model_idx]('base_decoder.yaml', data)
        else:
